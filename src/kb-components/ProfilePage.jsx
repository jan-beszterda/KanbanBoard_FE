      ...
      <div className="w-[1070px] h-[450px] bg-light-grey rounded-md flex flex-row drop-shadow-sm gap-10 pl-10 pt-10  ">
        <div className=" w-[350px] h-[175px] bg-white rounded-md drop-shadow-[0_5px_5px_rgba(0,0,0,0.25)]">
          <div className=" mx-5 my-5 ">
            ...
            <hr />
            <p className=" text-sm text-end mt-3 text-gray-600 italic">
              BoardIT - Team
            </p>
          </div>
        </div>
        ...
        <div className=" w-[600px] h-[380px] bg-white flex flex-row rounded-md drop-shadow-[0_5px_5px_rgba(0,0,0,0.25)] gap-5">
          <div className=" my-5 pl-10 pr-5  border-[1px] border-white border-r-gray-200">
            <div className=" flex flex-row  mb-5  ">
              ...
              <h1 className=" pl-3 self-center text-2xl font-bold font-sans capitalize">
                {userName}
              </h1>
              <BiEdit
                onClick={openModal}
                color="#FF8E7F"
                size={"20"}
                className="self-center ml-5 cursor-pointer "
              ></BiEdit>
              {editNameModal ? (
                <CreateBtn
                  btnTitle={"New name"}
            ...
            <div>
              <p className=" text-gray-600 font-sans font-semibold mb-5 ml-2">
                About me
              </p>

              <textarea
                className=" h-[150px] text-sm border-[1px] border-dark-grey rounded-md py-2 px-2"
          ...
          <div className=" bg-white mt-10 flex flex-col gap-6">
            <div className=" flex flex-row  gap-[17px]">
              ...
              <p className=" border-[1px] text-gray-400 italic  border-dark-grey text-sm pt-1 px-1 rounded-md w-[160px] pl-3 ">
                {activeUser.email}
              </p>
            </div>
            ...
            <div className=" flex flex-row gap-[10px]">
              ...
              <p className=" border-[1px] text-gray-400 italic border-dark-grey  text-sm pt- px-1 rounded-md w-[160px] pl-3">
                xxx-xxx-xxx
              </p>
            </div>
          </div>
