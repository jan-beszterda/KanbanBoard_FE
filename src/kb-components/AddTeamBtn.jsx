              ...
              <div className="relative w-auto my-6 mx-auto max-w-xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  <div className="relative p-6  ">
                    ...
                    <input className=' border-2 border-gray-300 rounded-md' type="text" value={teamName} onChange={e => setTeamName(e.target.value)}/>
                  </div>
                  <div className="relative p-6 pt-3 ">
                    <p className='mb-5  font-bold '>Description</p>
                    <textarea  className=' h-40 border-2 border-gray-300 rounded-md' type="text" value={teamDescription} onChange={e => setTeamDescription(e.target.value)}/>
                  </div>
                  {/*footer*/}
